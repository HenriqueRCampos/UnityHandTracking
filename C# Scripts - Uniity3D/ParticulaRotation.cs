...
public class ParticulaRotation : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (HandMoviments.rotacionar && !UDPReceiveRe.Igual1 && selection.Selecionado == null && animationInicial)
        {
        ...
        else if (HandMoviments.rotacionar && !UDPReceiveRe.Igual1 && selection.Selecionado == null && animationSepararPeca)
        {
