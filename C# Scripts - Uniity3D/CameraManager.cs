...
public class CameraManager : MonoBehaviour
{
    ...
    void Update()
    {
        if (HandMoviments.rotacionar && !UDPReceiveRe.Igual1 && selection.Selecionado == null)
        {
        ...
        }else if (HandMoviments.rotacionar && !UDPReceiveRe.Igual1 && selection.Selecionado == GameObject.FindWithTag("alizar"))
        {
        ...
        else if (HandMoviments.rotacionar && !UDPReceiveRe.Igual1 && selection.Selecionado == GameObject.FindWithTag("alizar2"))
        {
        ...
        else if (HandMoviments.rotacionar && !UDPReceiveRe.Igual1 && selection.Selecionado == GameObject.FindWithTag("folha"))
        {
        ...
        else if (HandMoviments.rotacionar && !UDPReceiveRe.Igual1 && selection.Selecionado == GameObject.FindWithTag("folha2"))
        {
        ...
        else if (HandMoviments.rotacionar && !UDPReceiveRe.Igual1 && selection.Selecionado == GameObject.FindWithTag("macaneta"))
        {
        ...
        else if (HandMoviments.rotacionar && !UDPReceiveRe.Igual1 && selection.Selecionado == GameObject.FindWithTag("marco"))
        {
        ...
        else if (HandMoviments.rotacionar && !UDPReceiveRe.Igual1 && selection.Selecionado == GameObject.FindWithTag("recheio"))
        {
